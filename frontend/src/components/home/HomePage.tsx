...
export const HomePage: React.FC = () => {
  const { setMainTab, setAuthoritySubTab, stats } = useApp();
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl border border-slate-200/80 p-8 sm:p-12 shadow-xs relative overflow-hidden">
          <div className="max-w-3xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-800 border border-blue-200 text-xs font-semibold uppercase tracking-wider">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <button
                ...
                className="flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm shadow-sm transition-all text-center"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold text-sm border border-slate-300 transition-all text-center"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <span className="text-[11px] text-slate-500 mt-0.5 block">Multilingual voice & text</span>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <span className="text-[11px] text-slate-500 mt-0.5 block">Demand-deficit overlaps</span>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <span className="text-[11px] text-slate-500 mt-0.5 block">Sectors &lt; 40/100 index</span>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-2xs">
            ...
            <span className="text-[11px] text-slate-500 mt-0.5 block">Active administrative review</span>
          </div>
        </div>
      </section>
